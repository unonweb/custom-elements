	...
	*/
	...
	connectedCallback() {
		...
		if (!this.dataset.state) {
			console.warn(this, 'this.dataset.state', this.dataset.state, 'This can cause FOUC!')
			this.dataset.state = 'off'
		}
		if (!this.dataset.overlay) {
			console.warn(this, 'this.dataset.overlay', this.dataset.overlay, 'This can cause FOUC!')
			this.dataset.overlay = 'false' // don't init to true because it can cause FOUC
		}
