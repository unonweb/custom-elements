...
class UnMapLeaflet extends HTMLElement {
	...
	connectedCallback() {
		...
		this.dataset.lat ??= 48
		this.dataset.lon ??= 9
		this.dataset.zoom ??= 13 // no att yet
		this.dataset.pin ??= '' // "false", "svg-triangle", "svg-round", "div", "png-default"
		this.dataset.pintext ??= ''
		...
		this.mapElement = this.querySelector("#map")
		...
		if (this.dataset.flyToAnimation) {
			setTimeout(() => {
...
customElements.define("un-map-leaflet", UnMapLeaflet);
